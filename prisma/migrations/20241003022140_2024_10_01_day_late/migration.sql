...
-- CreateIndex
CREATE UNIQUE INDEX "_ListenerPromptViews_AB_unique" ON "_ListenerPromptViews"("A", "B");

-- CreateIndex
CREATE INDEX "_ListenerPromptViews_B_index" ON "_ListenerPromptViews"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_ListenerVideoViews_AB_unique" ON "_ListenerVideoViews"("A", "B");

-- CreateIndex
CREATE INDEX "_ListenerVideoViews_B_index" ON "_ListenerVideoViews"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_PromptResponseToThematicVideo_AB_unique" ON "_PromptResponseToThematicVideo"("A", "B");
