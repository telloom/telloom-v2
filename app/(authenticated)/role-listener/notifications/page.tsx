...
export default function ListenerNotificationsPage() {
  ...
  const handleNotificationClick = async (notification: Notification) => {
    try {
      ...
      switch (notification.type) {
        case 'FOLLOW_REQUEST':
          router.push('/role-listener/connections?tab=pending');
          break;
        case 'CONNECTION_CHANGE':
          router.push('/role-listener/connections?tab=active');
          break;
        default:
          router.push('/role-listener/connections');
      }
    } catch (error) {
