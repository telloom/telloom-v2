  ...
  useEffect(() => {
    ...
    const checkUser = async () => {
      ...
      try {
        ...
        const userRole = roles[0].role; // Renamed role to userRole
        console.log('[ROOT PAGE] Redirecting based on role:', userRole);
        ...
        console.error('[ROOT PAGE] Unexpected error during auth check:', e);
        router.push('/login');
      }
    };
